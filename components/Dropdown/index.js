   ...
   return (
      <Menu
         ...
         <Transition
            ...
            <Menu.Items className="dark:shadow-gray-900 dark:border dark:border-gray-800 origin-top-left lg:origin-top-right absolute lg:right-0 left-0 mt-2 w-56 rounded-md shadow-lg bg-white dark:bg-gray-900 ring-1 ring-black ring-opacity-5 divide-y divide-gray-100 dark:divide-gray-700 focus:outline-none z-10">
               <div className="py-1">
