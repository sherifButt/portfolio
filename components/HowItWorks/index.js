        ...
        <div className="flex flex-wrap -mx-8 text-center">
           <div className="lg:w-1/3 px-8 mb-8 lg:mb-0">
              ...
              <p className="text-gray-400 leading-relaxed">
                 During the phone call we will be able to present
                 you all details of cooperation, pricing and
                 special offers, suited for your company.
              </p>
           </div>
           <div className="lg:w-1/3 px-8 mb-8 lg:mb-0">
              <svg
           ...
           <div className="lg:w-1/3 px-8 mb-8 lg:mb-0">
              ...
              <p className="text-gray-400 leading-relaxed">
                 You don’t buy a pig... or shall I say a paper in
                 a poke. The supplies will be delivered to your
                 company every first Monday of the month.
              </p>
           </div>
           <div className="lg:w-1/3 px-8 my-8 lg:mb-0">
              <svg
                 className="text-indigo-600 w-8 h-8 mx-auto"
                 fill="none"
                 stroke="currentColor"
