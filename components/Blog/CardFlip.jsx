      ...
      <ReactCardFlip
         ...
         <div className=" flex flex-col rounded-lg shadow-lg overflow-hidden  dark:bg-gray-800 bg-white bg-clip-padding backdrop-filter backdrop-blur-xl dark:bg-opacity-30 bg-opacity-40">
           ...
           {!isFlipped&& <img
               ...
               alt=""
            />}
            { !isFlipped && <p className=" text-sm p-1 mt-1 font-medium dark:text-indigo-400  text-indigo-600 hidden md:inline-block ">
         ...
         <div
            ...
            {!isFlipped&&<p className="invisible "></p>}
            ...
            {isFlipped&&<div className="flex-1  p-6 flex flex-col justify-between ">
