      ...
      <>
            ...
            <div>
               <div className="flex flex-wrap items-center -mx-8">
                  ...
                  <div className="md:w-1/2 px-8 mb-8">
                     ...
                     <p className="text-gray-400 leading-relaxed">
                        ...
                        pricing and special offers, suited for
                        your company.
                     </p>
                  </div>
               </div>
               <div className="flex flex-wrap items-center -mx-8">
                  ...
                  <div className="md:w-1/2 px-8 md:text-right">
                     ...
                     <p className="text-gray-400 leading-relaxed">
                        We can also talk during business meeting,
                        or visit your office anytime you want!
                        Our employees will provide proper
                        contracts.
                     </p>
                  </div>
               </div>
               <div className="flex flex-wrap items-center -mx-8">
                  ...
                  <div className="md:w-1/2 px-8">
                     ...
                     <p className="text-gray-400 leading-relaxed">
                        ...
                        delivered to your company every first
                        Monday of the month.
                     </p>
                  </div>
               </div>
         ...
         <section className="py-12 px-4">
            ...
            <div className="flex flex-wrap -mx-4 mb-6">
               ...
               <div className="lg:w-1/4 px-4 mb-6">
                  ...
                  <p className="text-sm text-gray-400 leading-relaxed">
                     Multi-functional paper for various office
                     needs. Snow-white sheets will shine bright
                     like diamond for many years.
                  </p>
               </div>
               <div className="lg:w-1/4 px-4 mb-6">
                  <svg
                  ...
                  <p className="text-sm text-gray-400 leading-relaxed">
                     ...
                     comes with our paper. The offer includes
                     wides ranges of density.
                  </p>
               </div>
               <div className="lg:w-1/4 px-4 mb-6">
                  <svg
            ...
            <div className="text-center">
               ...
               <p className="text-sm text-gray-400 mt-5">
                  Your own Dunder Mifflin account will serve you
                  in the wonderful voyage through our products.
               </p>
            </div>
         </section>
         ...
         <section className="pt-8 px-4 text-center">
            <div className="max-w-2xl mx-auto mb-8">
               ...
               <p className="text-gray-400 leading-relaxed">
                  See how paper can change the way you think
                  about business.
               </p>
            </div>
         ...
         <section className="py-12 px-4 text-center">
            <div className="max-w-2xl mx-auto">
               ...
               <p className="text-gray-400 leading-relaxed">
                  We deliver our services with passion and
                  dedication unmatched by other so called "big
                  players". We create a friendly environment for
                  our workers and that’s what makes their
                  dedication soar to the maximum.
               </p>
            </div>
         </section>
            ...
            <div className="flex flex-wrap -mx-8">
               <div className="md:w-1/3 p-8">
                  ...
                  <p className="mt-4 text-gray-400 leading-relaxed">
                     Started as a Sales representative at
                     Stamford branch, moved to Scranton.All of us
                     left as soon as possible except for Andy.
                  </p>
               </div>
               <div className="md:w-1/3 p-8 md:border-l">
                  ...
                  <p className="mt-4 text-gray-400 leading-relaxed">
                     ...
                     started there as an Assistant and finally
                     got a promotion to the Marketing Director.
                  </p>
               </div>
               <div className="md:w-1/3 p-8 md:border-l">
                  <img
                  ...
                  <p className="mt-4 text-gray-400 leading-relaxed">
                     I work for Dunder Mifflin for a few years
                     now.I learned a lot.You know, one person
                     department is not easy to manage.
                  </p>
               </div>
            </div>
         </section>
            ...
            <div className="flex flex-wrap text-center">
               <div className="w-full md:w-1/3 mb-8 md:mb-0">
                  <div className="h-full flex flex-col py-8 px-6 border">
                     ...
                     <p className="mb-auto text-gray-400 leading-relaxed">
                        ...
                        enough to waste it on fluffy animals
                        photos.
                     </p>
               ...
               <div className="w-full md:w-1/3 mb-8 md:mb-0">
                  <div className="relative h-full flex flex-col py-8 px-6 border-4 border-green-500 shadow-lg">
                     ...
                     <p className="mb-8 text-gray-400 leading-relaxed">
                        That’s what we’re talking about! More
                        reams of paper is a really reamful
                        choice.
                     </p>
                     <h4 className="text-3xl font-semibold font-heading">
                        $49
               ...
               <div className="w-full md:w-1/3 mb-8 md:mb-0">
                  <div className="h-full flex flex-col py-8 px-6 border">
                     ...
                     <p className="mb-auto text-gray-400 leading-relaxed">
                        Big business needs big amount of paper.
                        The best quality comes with Dunder
                        Mifflin paper.
                     </p>
                     <h4 className="text-3xl font-semibold font-heading">
                        $99
               ...
               <div className="flex flex-wrap -mx-8">
                  <div className="lg:w-1/2 px-8 mb-8">
                     <h3 className="text-lg mb-1 font-semibold font-heading font-semibold">
                        How does Dunder Mifflin paper differ from
                        other products?
                     </h3>
                     <p>
                        Paper produced with love, devotion,
                        passion - is not the same paper. Our
                        supplies are extra strong, and you’re
                        going to need the paper-tear up-master to
                        destroy just one sheet. It’s also suited
                  ...
                  <div className="lg:w-1/2 px-8 mb-8">
                     ...
                     <p>
                        If you buy one of our business plans, you
                        will receive the supplies every first
                        Monday of the month. However, you can
                        also purchase paper separately. Our
                        employees will make sure that you will
                        receive the products in the next business
                        days.
                     </p>
                  </div>
                  <div className="lg:w-1/2 px-8 mb-8">
                     <h3 className="text-lg mb-1 font-semibold font-heading font-semibold">
                        Why choose Dunder Mifflin instead of some
                        huge paper producer?
                     </h3>
                     <p>
                        You know that feeling when you are
                        waiting on the phone for hours to contact
                        your supplier? Sometimes they even have a
                        waiting time music prepared for that. In
                        Dunder Mifflin, you can get help
                        immediately, and each of our customers
                        receives an individual assistant.
                     </p>
                  </div>
                  <div className="lg:w-1/2 px-8 mb-8">
                     <h3 className="text-lg mb-1 font-semibold font-heading font-semibold">
                        What makes Dunder Mifflin so special
                        among other companies?
                     </h3>
                     <p>
                        We’re dedicated to ensuring the highest
                        level of customer satisfaction based on
                        long-term professional relationships. By
                        creating a positive working environment,
                        we’re enabling our employees to
                        significantly improve not only their
                        productivity but what’s more important –
                        job satisfaction.
                     </p>
                  </div>
                  <div className="lg:w-1/2 px-8 mb-8">
                     <h3 className="text-lg mb-1 font-semibold font-heading font-semibold">
                        Do you offer bargains for regular
                        clients?
                     </h3>
                     <p>
                        Thank you for asking, great question! We
                        highly value long-term relationships with
                        our clients, and that’s why we regularly
                        thank them for their trust by giving
                        significant discounts. Moreover, we offer
                        a 10% rebate for every new customer! For
                        more information, please contact our HQ
                        in Scranton.
                     </p>
                  </div>
                  <div className="lg:w-1/2 px-8 mb-8">
                     <h3 className="text-lg mb-1 font-semibold font-heading font-semibold">
                        How long does it take to finalize the
                        deal?
                     </h3>
                     <p>
                        The whole process depends on your
                        decision. If you sign the contract
                        immediately, we can start official
                        cooperation in the next two business
                        days.
                     </p>
                  </div>
               </div>
            ...
            <div className="flex flex-wrap items-center max-w-6xl mx-auto">
                  ...
                  <div className="pt-10 pb-6 px-10 bg-white rounded shadow">
                     <ul>
                        <li className="mb-3">
                           ...
                           <span>
                              Our paper is literally tempting you
                              to print something
                           </span>
                        </li>
                        <li className="mb-3">
                           ...
                           <span>
                              Order our services without leaving
                              your office
                           </span>
                        </li>
                        <li className="mb-3">
               ...
               <div className="lg:w-1/2 px-4 lg:pl-20">
                  ...
                  <p className="mt-6 mb-8 text-gray-400 leading-relaxed">
                     Are you a carte blanche of the paper
                     industry? No worries, our team will help you
                     in implementation process and dispel doubts.
                  </p>
                  <div>
                     <a
